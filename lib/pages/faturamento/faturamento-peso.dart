...
class FaturamentoPeso extends StatefulWidget {
  final ModelFiltroFaturamento filtro;

  FaturamentoPeso(this.filtro);

  @override
  _FaturamentoPesoState createState() => _FaturamentoPesoState();
}

class _FaturamentoPesoState extends State<FaturamentoPeso> {
