...
part of 'frota-propria-controller.dart';
...
mixin _$FrotaPropriaController on _FrotaPropriaControllerBase, Store {
  ...
  final _$impostoPercAtom =
      Atom(name: '_FrotaPropriaControllerBase.impostoPerc');
  ...
  final _$custoFixoValAtom =
      Atom(name: '_FrotaPropriaControllerBase.custoFixoVal');
  ...
  final _$custoFixoPercAtom =
      Atom(name: '_FrotaPropriaControllerBase.custoFixoPerc');
  ...
  final _$custoVariavelValAtom =
      Atom(name: '_FrotaPropriaControllerBase.custoVariavelVal');
  ...
  final _$custoVariavelPercAtom =
      Atom(name: '_FrotaPropriaControllerBase.custoVariavelPerc');
  ...
  final _$resultadoValAtom =
      Atom(name: '_FrotaPropriaControllerBase.resultadoVal');
  ...
  final _$resultadoPercAtom =
      Atom(name: '_FrotaPropriaControllerBase.resultadoPerc');
