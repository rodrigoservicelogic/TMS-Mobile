...
const double titleLarge = 25;
const double titleMedium = 20;
const double titleSmall = 15;

const int maxAspectRation = 3;
const int minAspectRation = 1;
